    ...
    while is_zhandou:#开始战斗
        ...
        if player_code=='0' or player_code=='逃跑':
            ...
            while ac_0==True:
                try:
                    ...
                    if player_wearing_skill[skill_code] != None:
                    
                 
                        skill_id=skill0_name_id[player_wearing_skill[skill_code]]
                      ...
                      #结算敌人血量
                        player_sx0['生命值']=back_message[1]['生命值']
            ...
            while True:
                ...
                if player_zs == 1:
                    ...
                    shanghai=1.5*(player_sx0['攻击力']-attack_npc_sx['防御力'])
                elif player_zs == 2:
                    player_zs_describe='随手打出一拳，向「'+attack_npc_name+'」猛的锤去'
                    shanghai=1.25*(player_sx0['攻击力']-attack_npc_sx['防御力'])
                elif player_zs == 3:
                    player_zs_describe='一道鞭腿，向「'+attack_npc_name+'」猛的砍去'
                    shanghai=randint(1,2)*(player_sx0['攻击力']-attack_npc_sx['防御力'])
                elif player_zs == 4:
                    player_zs_describe='一掌向前，向「'+attack_npc_name+'」猛的拍去'
                    shanghai=player_sx0['攻击力']-attack_npc_sx['防御力']+1
            #结算
                if shanghai<0:
                    shanghai=1
        ...
        #玩家普攻敌人也普攻
                ...
                if player_zs == 1:
                    ...
                    shanghai=1.25*(attack_npc_sx['攻击力']-player_sx0['防御力'])
                elif player_zs == 3:
                    player_zs_describe='一道鞭腿，向「'+'你'+'」猛的砍去'
                    shanghai=randint(1,2)*(attack_npc_sx['攻击力']-player_sx0['防御力'])
                elif player_zs == 4:
        ...
        if player_alive==False:
            ...
            back_message=['失败',player_sx0['生命值']]
            return back_message
            ...
            back_message=['胜利',player_sx0['生命值']]
            return back_message
        print('*'*30)
